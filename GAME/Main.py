...
board_center = Board('l2/l2.csv', (0 - CELL_SIZE[0], 0), 1920 + CELL_SIZE[0], CENTER, 1500)
board_left = Board('l2/l2.csv', (0 - CELL_SIZE[0], 0), (WINDOW_W + CELL_SIZE[0]) // 2, CENTER_LEFT, 1500)
...
while running:
    ...
    board_center.update()
    board_left.copyFrom(board_center)
    board_right.copyFrom(board_center)
    characters.update()
